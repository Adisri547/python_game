...
class display:
    ...
    def game_intro(self):
        ...
        while True:
            ...
            self.display.blit(TextSurf, TextRect)
            TextSurf2, TextRect2 = self.text_objects('by CSE 18', smallText, black)
            ...
            if ((car.y >= cur_part.y and car.y <= cur_part.y + cur_part.height) or (cur_part.y >= car.y and cur_part.y <= car.y + car.height)) and (
                ...
                if cur_part.color == green:
                    ...
                    # next wave starts
                        ...
                        place_list=['KP_16 reception','Cricket_Stadium','KSAC','The Address','Khao Gully','Campus 6','Central Library','Kims','Successful!']
                        particle_amount += 2
